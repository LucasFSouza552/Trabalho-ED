...
public class ArvoresAVL {
    ...
    public void mostrarTempos() {
        ...
        System.out.printf("| %-"+maxLengths[0]+"s | %-"+maxLengths[1]+"s | %-"+maxLengths[2]+"s | %-"+maxLengths[3]+"s | %-"+maxLengths[4]+"s | %-"+maxLengths[5]+"s | %-"+maxLengths[6]+"s |%n", (Object[]) headers);
    
        System.out.println("|" + "-".repeat(maxLengths[0]) + "|-" + "-".repeat(maxLengths[1]) + "-|-" + "-".repeat(maxLengths[2]) + "-|-" + "-".repeat(maxLengths[3]) + "-|-" + "-".repeat(maxLengths[4]) + "-|-" + "-".repeat(maxLengths[5]) + "-|-" + "-".repeat(maxLengths[6]) + "-|");
    
        for (String[] row : data) {
            System.out.printf("| %-"+maxLengths[0]+"s | %-"+maxLengths[1]+"s | %-"+maxLengths[2]+"s | %-"+maxLengths[3]+"s | %-"+maxLengths[4]+"s | %-"+maxLengths[5]+"s | %-"+maxLengths[6]+"s |%n", (Object[]) row);
        }
    }
